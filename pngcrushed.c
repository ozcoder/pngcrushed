...
/* pngcrushed.c - recompresses png files
 * Copyright (C) 2022 ozcoder
...
#if PNGCRUSH_LIBPNG_VER < 10800 || defined(PNGCRUSHED_H)
 ...
 */
#  ifdef PNGCRUSHED_H  /* Why would this not work with the system library? */
...
#  define BUNDLED_LIB "system"
    ...
    fprintf(STDERR,
      ...
      PNGCRUSHED_VERSION, progname, PNGCRUSH_VERSION,
...
#endif /* PNGCRUSH_LIBPNG_VER < 10800 || defined(PNGCRUSHED_H) */
